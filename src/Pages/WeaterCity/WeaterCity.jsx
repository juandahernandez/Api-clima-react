...
const WeaterCity = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${name}&units=metric&appid=${process.env.REACT_APP_API_KEY}`)
    ...
    const backgrounds = {
        ...
        Rain:
          "http://static-1.ivoox.com/audios/2/5/5/9/1531576489552_XXL.jpg",
        Mist: 
        "https://media3.giphy.com/media/ZWRCWdUymIGNW/giphy.gif",
        Drizzle:
